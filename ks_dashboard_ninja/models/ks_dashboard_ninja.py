...
class KsDashboardNinjaBoard(models.Model):
    ...
    ks_dashboard_items_ids = fields.One2many('ks_dashboard_ninja.item', 'ks_dashboard_ninja_board_id',string='Dashboard Items')
    ...
    ks_dashboard_top_menu_id = fields.Many2one('ir.ui.menu',domain="['|',('action','=',False),('parent_id','=',False)]",
                                               string="Show Under Menu",default=lambda self: self.env['ir.ui.menu'].search(
                                                   [('name', '=', 'My Dashboard')]))
    ...
    ks_dashboard_default_template = fields.Many2one('ks_dashboard_ninja.board_template',default=lambda self: self.env.ref('ks_dashboard_ninja.ks_blank',False),
    ...
    ks_dashboard_menu_sequence = fields.Integer(string="Menu Sequence", default=10,help="Smallest sequence give high priority and Highest sequence give "
                                                     "low priority")
    ks_child_dashboard_ids = fields.One2many('ks_dashboard_ninja.child_board', 'ks_dashboard_ninja_id')
    ks_dashboard_defined_filters_ids = fields.One2many('ks_dashboard_ninja.board_defined_filters','ks_dashboard_board_id',
                                                       string='Dashboard Predefined Filters')
    ks_dashboard_custom_filters_ids = fields.One2many('ks_dashboard_ninja.board_custom_filters','ks_dashboard_board_id',
