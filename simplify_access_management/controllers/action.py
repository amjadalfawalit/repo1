...
class Action(main.Action):
    ...
    def load(self, action_id, additional_context=None):
        ...
        for access in request.env['remove.action'].sudo().search([('access_management_id','in',request.env.user.access_management_ids.ids),('model_id.model','=',res.get('res_model'))]):
