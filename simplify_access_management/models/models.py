...
class BaseModel(models.AbstractModel):
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        ...
        readonly_access_id = self.env['access.management'].search([('user_ids','in',self.env.user.id),('readonly','=',True)])

        access_recs = self.env['access.domain.ah'].search([('access_management_id.user_ids','in',self.env.user.id),('access_management_id.active','=',True),('model_id.model','=',res['model'])])
        delete = 'false'
        edit = 'false'
        create = 'false'
